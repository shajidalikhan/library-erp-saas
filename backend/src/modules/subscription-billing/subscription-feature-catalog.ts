 ...
 * `frontend/src/modules/subscription/subscription-feature-catalog.ts`.
 */
...
export const SUBSCRIPTION_FEATURE_KEYS_SET = new Set<string>(SUBSCRIPTION_FEATURE_KEYS);

/** Legacy plan keys merged into canonical keys when resolving access. */
export const SUBSCRIPTION_FEATURE_LEGACY_ALIASES: Record<string, string[]> = {
  analytics: ['advanced_analytics'],
  exports: ['reports_export'],
  whatsapp: ['whatsapp_notifications'],
  sms: ['sms_notifications'],
  qr_attendance: ['attendance_qr'],
  automation_jobs: ['automation'],
};

export function defaultPlanFeatureFlags(): Record<string, boolean> {
